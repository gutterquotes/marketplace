...
${chalk.dim(
  'The marketplace name is needed for the marketplace texts. If not set through environment variables, the name defaults to "Gutter Quotes" (set in src/config/configDefault.js)'
)}
`,
