...
export const listingFields = [
  {
    ...
    schemaType: 'enum',
    enumOptions: [
      { option: 'installation', label: 'Seamless gutter installation' },
      { option: 'replacement', label: 'Gutter replacement' },
      { option: 'repair', label: 'Gutter repair' },
    ...
    saveConfig: {
      label: 'Service needed',
      placeholderMessage: 'Select a service',
      isRequired: true,
      requiredMessage: 'Select the gutter service you need.',
    },
  },
  {
    key: 'projectZip',
    ...
    saveConfig: {
      ...
      isRequired: true,
      requiredMessage: 'Add the project ZIP code.',
    },
  },
  {
    key: 'homeType',
    ...
    schemaType: 'enum',
    enumOptions: [
      { option: 'single-family', label: 'Single-family home' },
      { option: 'townhome', label: 'Townhome' },
      { option: 'multi-family', label: 'Multi-family' },
      { option: 'commercial', label: 'Commercial property' },
    ],
    showConfig: {
      label: 'Home type',
      isDetail: true,
    ...
    saveConfig: {
      label: 'Home type',
      placeholderMessage: 'Select property type',
      isRequired: false,
    },
  },
  {
    ...
    schemaType: 'enum',
    enumOptions: [
      { option: 'emergency', label: 'Emergency' },
      { option: 'week', label: 'This week' },
      { option: 'month', label: 'This month' },
      { option: 'planning', label: 'Planning ahead' },
    ],
    filterConfig: {
      showFilter: true,
      filterType: 'SelectSingleFilter',
  ...
  },
  {
    ...
    saveConfig: {
      label: 'Project details',
      placeholderMessage: 'Describe the gutter work, current issue, measurements, and access notes.',
      isRequired: true,
      requiredMessage: 'Add a short project description.',
    },
  },
];
